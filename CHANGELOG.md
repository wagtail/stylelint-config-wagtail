...
- Prevent false positive with 'color' value checks applying to `color-scheme` property.

## [1.0.0](https://github.com/wagtail/stylelint-config-wagtail/releases/tag/1.0.0) - 2025-12-08

### Changed

- Upgrade to Stylelint 16, and latest version of other config/plugin packages ([#45](https://github.com/wagtail/stylelint-config-wagtail/pull/45)).
